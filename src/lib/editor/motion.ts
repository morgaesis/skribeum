...
import { motionDurationMilliseconds, motionEasing } from "../motion";
...
/** Stops whatever this module was already playing on an element. */
function cancelReveal(element: HTMLElement): void {
