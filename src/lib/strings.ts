...
export const STRINGS = {
  ...
  noVaultBody: "Choose a folder of Markdown files to open it as a vault.",
  noNoteOpenHeading: "No note is open",
  findNote: "Find a note",
  searchNoteText: "Search note text",
  emptyVaultHeading: "This vault is empty",
  emptyVaultBody:
    "Notes are Markdown files in the vault folder. Create one to begin.",
  recentEditedJustNow: "Just now",
  emptyPaneLoading: "Loading recent notes",
  ...
  focusPaneAbove: "Focus pane above",
  focusPaneBelow: "Focus pane below",
  focusLeftPane: "Focus left pane",
  focusRightPane: "Focus right pane",
  moveTabToPaneAbove: "Move tab to pane above",
  moveTabToPaneBelow: "Move tab to pane below",
  moveTabToPaneLeft: "Move tab to pane left",
  moveTabToPaneRight: "Move tab to pane right",
  ...
  thematicBreakLabel: "Thematic break",
  footnoteReferenceLabel: "Footnote",
  footnoteDefinitionLabel: "Footnote definition",
  ...
  canvasWriteFailed: "Saving the canvas failed",
  canvasAddCard: "Add card",
  canvasAddCardPrompt: "Note path",
  canvasAddCardNotFound: "No note exists at that path.",
  canvasAddCardDuplicate: "That note is already on the canvas.",
  canvasRemoveCard: "Remove card",
  ...
  headingIncreaseLevel: "Increase heading level",
  headingDecreaseLevel: "Decrease heading level",
  listIndent: "Indent list item",
  listOutdent: "Outdent list item",
